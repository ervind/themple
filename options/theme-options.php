...
$tpl_option_array = array (
		...
		"parts"			=> array(
			array(
				"name"			=> 'icon_code',
				"title"			=> __( 'Font Awesome Icon Code', 'themple-starter' ),
		        "description"	=> __( 'The Font Awesome code of the icon (uses the fa-xxx name structure)', 'themple-starter' ),
				"type"			=> 'text',
				"prefix"		=> 'fa-',
			),
			array(
				"name"			=> 'icon_url',
				"title"			=> __( 'Icon URL', 'themple-starter' ),
		        "description"	=> __( 'Where should the icon be linked to?', 'themple-starter' ),
				"type"			=> 'text',
			),
			array(
				"name"			=> 'icon_title',
				"title"			=> __( 'Icon Title', 'themple-starter' ),
		        "description"	=> __( 'This is displayed when hovering the mouse over the icon', 'themple-starter' ),
				"type"			=> 'text',
			),
			array(
                "name"			=> 'icon_color',
                "title"			=> __( 'Icon Color', 'themple-starter' ),
                "description"	=> __( 'What should be the color of this icon?', 'themple-starter' ),
                "type"			=> 'color',
                "default"		=> '#666666',
            ),
		),
