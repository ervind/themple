...
add_action ( 'shutdown', 'tpl_make_css' );
...
function tpl_admin_scripts( ) {
	...
	wp_localize_script( 'tpl-admin-scripts', 'Themple_Admin', array(
...
function tpl_vars_to_js() {
	...
	foreach ( $tpl_options_array as $option ) {
		...
		if ( isset ( $option->js ) and ( $option->js == true ) ) {
