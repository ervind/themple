...
class TPL_Data_Type {
	...
	public function form_field_after () {
		...
		if ( !empty( $this->default ) ) {
			...
			echo __( 'default:', 'themple' ) . ' ' . tpl_kses( $this->format_option( $this->default ) );
	...
	public function admin_js_strings( $strings ) {
		...
		$strings = array_merge( $strings, array(
			...
			'Repeat_Minimize'		=> __( 'Minimize', 'themple' ),
			'Repeat_Maximize'		=> __( 'Maximize', 'themple' ),
			'Show_Settings'			=> __( 'Show Settings', 'themple' ),
			'Hide_Settings'			=> __( 'Hide Settings', 'themple' ),
		) );
